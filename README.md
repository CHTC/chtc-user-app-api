...
```shell
docker build --platform linux/amd64 -t hub.opensciencegrid.org/opensciencegrid/chtc-userapp-api:1.0.2 .
```

```shell
docker push hub.opensciencegrid.org/opensciencegrid/chtc-userapp-api:1.0.2
```
