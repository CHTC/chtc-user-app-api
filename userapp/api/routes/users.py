...
from userapp.core.models.views import JoinedProjectView as JoinedProjectViewTable, \
    UserGroupView as UserGroupViewTable  # TODO: Remove this — removed UserSubmitNodesView (submit nodes replaced by SUBMIT_NODE groups)
from userapp.core.models.tables import User as UserTable, UserProject, Group, UserGroup, Note as NoteTable  # TODO: Remove this — removed UserSubmit (submit nodes replaced by SUBMIT_NODE groups)
...
# TODO: Remove this — submit nodes replaced by SUBMIT_NODE groups.
# To get a user's submit nodes, fetch GET /users/{id}/groups and filter for type == SUBMIT_NODE.
